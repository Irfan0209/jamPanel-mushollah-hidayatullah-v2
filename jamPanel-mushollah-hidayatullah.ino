...
void loop() {
  ...
  switch(show) {
    ...
    case ANIM_TEXT1:
      ...
      break;
    case ANIM_TEXT2:
      drawSmartText(config.text2,config.speedText2,0);
      break;
    case ANIM_TEXT3:
      drawSmartText(config.text3,config.speedText3,0);
      break;
    case ANIM_TEXT4:
      drawSmartText(config.text4,config.speedText4,0);
      break;
    case ANIM_TEXT5:
      drawSmartText(config.text5,config.speedText5,0);
      break;
    case ANIM_ADZAN:
      drawAzzan();
      break;
